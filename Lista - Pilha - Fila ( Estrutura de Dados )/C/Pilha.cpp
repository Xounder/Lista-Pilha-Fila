		...
		switch(opcao){
			...
			case 4:
				...
				if(buscarElemento(lista, num)){
					printf("O elemento %d esta contido na Pilha", num);
				}else{
					printf("O elemento %d nao esta na Pilha", num);
				}
				break;
			case 5:
				printf("Tamanho da Pilha: %d", lista->tamanho);
				break;
			default:
